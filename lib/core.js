...
module.exports = function reglCore (
  ...
  function emitDrawBody (env, draw, args, program) {
    var VAO = env.link(args.vao)
    var hasAttributes = Boolean(program.attributes && program.attributes.length)

    if (vaoState.hasSupport && hasAttributes) {
      draw('if(', VAO, '){', VAO, '.bind(); }')
    }
